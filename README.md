Парсер категорий и подкатегорий интернет-магазина с использованием Selenium и BeautifulSoup. Парсер собирает информацию о категориях и подкатегориях, а также их URL, и сохраняет ее в JSON-файл.
